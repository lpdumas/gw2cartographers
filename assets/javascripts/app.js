...
(function() {
  ...
  Cartographer.highlighMarker = function(coord) {
    return this.currentMap.panToMarker(coord);
  };
  ...
  */
  ...
  Cartographer.CustomMap = (function() {
    ...
    function CustomMap(HTMLMapWrapperID, opts) {
      ...
      $('#destroy').bind('click', this.destroyLocalStorage);
      $('#send').bind('click', this.sendMapForApproval);
              ...
              for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
                ...
                if (coord.lat === marker.position.lat().toString() && coord.lng === marker.position.lng().toString()) {
                  ...
                  if (!(marker.infoWindow != null)) {
                    ...
                    _results2.push(this.currentOpenedInfoWindow = marker.infoWindow);
                  } else {
    ...
    CustomMap.prototype.addMenuIcons = function() {
      ...
      for (markerCat in this.MarkersConfig) {
        if (markerCat !== this.defaultCat) {
          _results.push(this.turnOfMenuIconsFromCat(markerCat));
        }
      }
      return _results;
    };
