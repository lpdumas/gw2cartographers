  ...
  */
  ...
  Cartographer.CustomMap = (function() {
    ...
    CustomMap.prototype.addMarker = function(markerInfo, otherInfo, isNew, defaultValue) {
      var iconPath, iconmid, iconsize, image, isMarkerDraggable, latLng, marker, markerTitle, markerVisibility, markersCat, markersType, options,
        _this = this;
  ...
  */
  ...
  CustomInfoWindow = (function() {
    ...
    CustomInfoWindow.prototype.bindButton = function() {
      var _this = this;
      console.log(this.wrap.find('.iw-options-list .button'));
      return this.wrap.find('.iw-options-list .button').bind('click', function(e) {
