  ...
  */
  ...
  Cartographer.CustomMap = (function() {
    ...
    function CustomMap(HTMLMapWrapperID, opts) {
      ...
      var confirmBoxTemplate, layer, tileUrl,
        _this = this;
    ...
    CustomMap.prototype.addMarker = function(markerInfo, otherInfo, isNew, defaultValue) {
      var iconPath, iconmid, iconsize, image, isMarkerDraggable, marker, markerTitle, markerVisibility, markersCat, markersType, options;
      iconsize = 32;
      iconmid = iconsize / 2;
      ...
      if (markerVisibility) {
        marker = new L.Marker(new L.LatLng(markerInfo.lat, markerInfo.lng), options).addTo(this.map);
        if (defaultValue != null) {
