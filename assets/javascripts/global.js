...
(function() {
  var App, AreaSummary, ChoiceBox, Confirmbox, CustomInfoWindow, CustomMap, Modalbox, att, attToCheck, extractUrlParams, html, _i, _len,
  ...
  */
  ...
  ChoiceBox = (function(_super) {

    __extends(ChoiceBox, _super);

    ChoiceBox.name = 'ChoiceBox';

    function ChoiceBox(template) {
      this.modal.addClass('choice-box');
      this.template = template;
    }

    ChoiceBox.prototype.initChoice = function(oContent, choicesActions) {
      return console.log(oContent);
    };
