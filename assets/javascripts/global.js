...
(function() {
  var AreaSummary, Confirmbox, CustomInfoWindow, Modalbox,
    _this = this,
  ...
  Cartographer.init = function() {
    var markersOptionsMenuToggle, myCartographerMap;
  ...
  */
  ...
  Cartographer._localStorageAvailable = (function() {
  ...
  Cartographer._URLParams = (function() {
  ...
  window.LANG = (function() {
    if ((Cartographer._URLParams['lang'] != null) && (Cartographer._URLParams['lang'] === 'fr' || Cartographer._URLParams['lang'] === 'en')) {
  ...
  Cartographer.Map = (function() {
    ...
    function Map(HTMLMapWrapperID) {
      ...
      this.defaultCat = (function() {
        ...
        dcat = "explore";
        if (Cartographer._URLParams['cat'] != null) {
          for (cat in Markers) {
            catObject = Markers[cat];
            if (cat === Cartographer._URLParams['cat']) {
    ...
    Map.prototype.handleLocalStorageLoad = function(callback) {
      var confirmMessage,
        _this = this;
      if (Cartographer._localStorageAvailable && this.getConfigFromLocalStorage()) {
    ...
    Map.prototype.getConfigFromLocalStorage = function() {
      var json;
      json = localStorage.getItem(this.localStorageKey);
      return JSON.parse(json);
    };

    Map.prototype.addMarker = function(markerInfo, otherInfo, isNew, defaultValue) {
    ...
    Map.prototype.setAllMarkers = function() {
    ...
    Map.prototype.destroyLocalStorage = function(e) {
      var confirmMessage,
        _this = this;
    ...
    Map.prototype.sendMapForApproval = function(e) {
    ...
    Map.prototype.handleAddTool = function(e) {
    ...
    Map.prototype.saveToLocalStorage = function() {
      var json;
      if (Cartographer._localStorageAvailable) {
    ...
    Map.prototype.getMarkerByCoordinates = function(lat, lng) {
    ...
    Map.prototype.turnOfMenuIconsFromCat = function(markerCat) {
      var menu;
    ...
    Map.prototype.addMenuIcons = function(callback) {
      var _this = this;
    ...
    Map.prototype.initializeAreaSummaryBoxes = function() {
      var _this = this;
      this.templateLoader = new Cartographer.TemplatesLoader();
    ...
    Map.prototype.setAreasInformationVisibility = function(isVisible) {
    ...
    Map.prototype.toggleMarkersOptionsMenu = function() {
      return this.markersOptionsMenu.toggleClass('active');
    };

    Map.prototype.hideMarkersOptionsMenu = function() {
      return this.markersOptionsMenu.addClass('off');
    };

    Map.prototype.showMarkersOptionsMenu = function() {
