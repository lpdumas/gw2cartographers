...
(function() {
  var AreaSummary, Confirmbox, CustomMap, Modalbox, extractUrlParams,
  ...
  */
  ...
  CustomMap = (function() {
    ...
    CustomMap.prototype.addMarker = function(markerInfo, markersType, markersCat) {
      var iconmid, iconsize, image, infoWindow, isMarkerDraggable, marker, markerThatMatchUrl, markerType, permalink, _i, _len, _ref, _results,
        _this = this;
      iconsize = 32;
      iconmid = iconsize / 2;
    ...
    CustomMap.prototype.handleExport = function(e) {
      var exportMarkerObject, jsonString, key, marker, markerTypeObject, markersCat, markersObjects, newmarkerTypeObject, nm, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      exportMarkerObject = {};
      _ref = this.gMarker;
    ...
    CustomMap.prototype.handleEdition = function(e) {
      var elements, this_, _i, _len, _ref;
      this_ = $(e.currentTarget);
      ...
      if (this_.hasClass('active')) {
        ...
        return this.html.addClass(this_.attr('id'));
      }
    };
